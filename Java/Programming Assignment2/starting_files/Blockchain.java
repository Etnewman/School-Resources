...
public class Blockchain extends JFrame {
	...
	public Blockchain() {
		...
		String[] names = {"Choose: ", "Ethan", "Jacob", "Luke", "Mohamed"}; 
		...
		signBtn.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				String tran = new String(payerCombo.getSelectedItem().toString() + " \n" +
										paidCombo.getSelectedItem().toString() + " \n" +
										txtAmount.getText() + " \n");
		...
		btnMineBlock.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Block temp = new Block(blockNum, currentTree, prevBlock, difficulty);
				
				//create a new block and pass in the Block Number, the Merkle Tree, the previous Block, and the difficulty				
				...
				ArrayList<String> tempArray = temp.toStringArray();
